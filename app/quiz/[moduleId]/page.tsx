...
export default function QuizPage() {
  ...
  const [moduleData, setModuleData] = useState<ModuleCompletionData | null>(
    null
  )
  ...
  useEffect(() => {
    ...
    const validateModuleCompletion = () => {
      try {
        const moduleCompletionData = localStorage.getItem(
          `module_completion_${moduleId}`
        )
        ...
        const completionData: ModuleCompletionData =
          JSON.parse(moduleCompletionData)
        setModuleData(completionData)

        // Validasi tambahan
        const isCompletedRecently = isCompletionRecent(completionData.timestamp)
        const hasVisitedAllPages =
          completionData.visitedPages.length === completionData.lastVisitedPage
        ...
        if (!isValid) {
          toast({
            ...
            description:
              'Pastikan Anda telah menyelesaikan seluruh modul dengan benar',
            variant: 'destructive',
          })
        }
      ...
      <div className="flex justify-center items-center min-h-screen">
        <Card className="w-[400px]">
          <CardHeader>
            ...
            <CardDescription>
              Sedang memvalidasi penyelesaian modul...
            </CardDescription>
          </CardHeader>
          <CardContent className="flex justify-center">
            <div className="animate-spin">
      ...
      <div className="flex justify-center items-center min-h-screen">
        <Card className="w-[400px]">
          <CardHeader>
            ...
            <CardDescription>
              Anda belum memenuhi prasyarat untuk mengakses quiz
            </CardDescription>
          </CardHeader>
          <CardContent className="flex justify-center">
      ...
      <div className="container mx-auto py-16 px-4 max-w-4xl">
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              Jawablah pertanyaan-pertanyaan berikut berdasarkan materi yang
              telah dipelajari
            </CardDescription>
          </CardHeader>
          <CardContent>
    ...
    <div className="container mx-auto py-16 px-4 max-w-4xl">
      <Card>
        <CardHeader>
          <CardTitle>Quiz Modul {moduleId}</CardTitle>
          <CardDescription>
            Selamat! Anda telah menyelesaikan modul dan siap untuk mengikuti
            quiz.
          </CardDescription>
        </CardHeader>
        <CardContent>
              ...
              <div className="flex items-center gap-2 mb-2">
                ...
                <span>
                  ...
                  <Badge variant="outline">
                    {moduleData.completionStatus}%
                  </Badge>
                </span>
              </div>
              <div className="text-sm text-muted-foreground">
                Modul diselesaikan pada:{' '}
                {new Date(moduleData.timestamp).toLocaleString('id-ID')}
              </div>
            </div>
          )}
          ...
          <div className="bg-muted p-6 rounded-md mb-6">
            ...
            <ul className="space-y-2 list-disc pl-5">
              <li>
                Quiz ini berisi pertanyaan tentang materi yang telah Anda
                pelajari
              </li>
