...
/_ Typography _/
--editor-font-sans: system-ui, -apple-system, BlinkMacSystemFont, "Segoe UI", Roboto, "Helvetica Neue", Arial,
sans-serif;
...
/_ Dark Mode Custom Properties _/
.dark {
...
position: relative;
/_ background-color: var(--editor-bg-default); _/
...
.ProseMirror _::selection {
background-color: var(--editor-highlight-blue);
/_ color: var(--editor-text-default); \*/
}
