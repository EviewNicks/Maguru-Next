...
describe('Navigasi Modul - Integration Tests', () => {
  ...
  describe('ModulePageFooterNav', () => {
    ...
    it('menampilkan loading indicator saat navigasi berlangsung', async () => {
      ...
      // Verifikasi bahwa tombol navigasi disabled saat navigasi berlangsung
      // Berdasarkan kode di ModulePageFooterNav.tsx, tombol akan disabled saat isNavigating=true
      const prevButton = screen.getByRole('button', {
        name: /halaman sebelumnya/i,
      })
      const nextButton = screen.getByRole('button', {
        name: /halaman berikutnya/i,
      })

      // Verifikasi bahwa tombol disabled
